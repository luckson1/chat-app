...
export const ChatCard = ({message}) => {
  ...
  const parentClassName= isCurrentUser? "bg-white h-fit w-11/12 flex flex-row-reverse gap-1 mt-2 items-center" : "bg-white h-fit w-11/12 flex flex-row gap-1 mt-2 items-center"
const childClassName= isCurrentUser ?  "bg-slate-400 w-56 md:w-4/12 text-white rounded-lg h-fit shadow-md" : "bg-indigo-700 w-56 md:w-4/12 text-white rounded-lg h-fit shadow-md"
  return (
